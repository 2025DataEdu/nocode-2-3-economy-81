...
const EmploymentChart = ({
  ...
  return <Card className="bg-card border border-border shadow-soft">
      <CardHeader>
        <CardTitle className="text-foreground">연도별 고용률 및 실업률 추이</CardTitle>
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={350}>
          ...
          bottom: 5
            ...
            <Legend />
            <Line type="monotone" dataKey="employment_rate" stroke="hsl(var(--chart-primary))" strokeWidth={3} name="고용률" dot={{
            ...
            <Line type="monotone" dataKey="unemployment_rate" stroke="hsl(var(--chart-secondary))" strokeWidth={3} name="실업률" dot={{
